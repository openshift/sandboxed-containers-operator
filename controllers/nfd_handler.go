...
// oscNodeTypeRule constructs the NodeFeatureRule that labels nodes for
// mixed-cluster scheduling based on the x86 CPUID hypervisor-present bit.
//
// Four rules:
//   - BM detection:       HYPERVISOR absent  → node-type=bare-metal + kata-capable=true
//   - VM detection:       HYPERVISOR present → node-type=virtual
//   - Nested Intel:       HYPERVISOR + VMX   → kata-capable=true + nested-virt-capable=true
//   - Nested AMD:         HYPERVISOR + SVM   → kata-capable=true + nested-virt-capable=true
				...
				"rules": []interface{}{
					map[string]interface{}{
						...
						"labels": map[string]interface{}{
							...
							"kataconfiguration.openshift.io/kata-capable": "true",
						},
					...
					map[string]interface{}{
						"name": "osc-nested-virt-intel",
						"labels": map[string]interface{}{
							"kataconfiguration.openshift.io/kata-capable":        "true",
							"kataconfiguration.openshift.io/nested-virt-capable": "true",
						},
						"matchFeatures": []interface{}{
							map[string]interface{}{
								"feature": "cpu.cpuid",
								"matchExpressions": map[string]interface{}{
									"HYPERVISOR": map[string]interface{}{"op": "Exists"},
									"VMX":        map[string]interface{}{"op": "Exists"},
								},
							},
						},
					},
					map[string]interface{}{
						"name": "osc-nested-virt-amd",
						"labels": map[string]interface{}{
							"kataconfiguration.openshift.io/kata-capable":        "true",
							"kataconfiguration.openshift.io/nested-virt-capable": "true",
						},
						"matchFeatures": []interface{}{
							map[string]interface{}{
								...
								"matchExpressions": map[string]interface{}{
									"HYPERVISOR": map[string]interface{}{"op": "Exists"},
									"SVM":        map[string]interface{}{"op": "Exists"},
								},
							},
						},
					},
