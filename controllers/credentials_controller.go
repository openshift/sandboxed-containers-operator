...
// Currently this is used for peer-pods-secrets created from environment-variable WIF/STS credentials.
...
// - CCO workflow: cco-secret created by CCO
// - ccoctl workflow: cco-secret created by ccoctl
