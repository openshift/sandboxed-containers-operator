...
```
image: registry.redhat.io/openshift-sandboxed-containers/osc-monitor-rhel9:1.13.0  ## OSC_VERSION
```
...
```
            - name: RELATED_IMAGE_KATA_MONITOR
              value: registry.redhat.io/openshift-sandboxed-containers/osc-monitor-rhel9:1.13.0  ## OSC_VERSION
```
