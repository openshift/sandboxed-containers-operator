...
func (in *KataConfigStatus) DeepCopyInto(out *KataConfigStatus) {
	*out = *in
	...
	out.UnInstallationStatus = in.UnInstallationStatus
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *KataInstallationCompletedStatus) DeepCopyInto(out *KataInstallationCompletedStatus) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new KataInstallationCompletedStatus.
func (in *KataInstallationCompletedStatus) DeepCopy() *KataInstallationCompletedStatus {
	if in == nil {
		return nil
	}
	out := new(KataInstallationCompletedStatus)
	in.DeepCopyInto(out)
	return out
}
