...
Please refer to this [doc](https://access.redhat.com/documentation/en-us/openshift_sandboxed_containers/1.5/html/openshift_sandboxed_containers_user_guide/deploying-sandboxed-containers-workloads) for getting started with sandboxed containers.
